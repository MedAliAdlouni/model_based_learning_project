...
# Source the GMM class from the current script
source("C:/projects/model_based_learning/td1/GMM_clustering_algo.R")
...
gmm_model <- GMM_clustering$new()
gmm_model$fit(X_train, K = 3)
